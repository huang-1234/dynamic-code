...
import { useContextStore, createStoreWithoutReducer, IDefReducer, useStoreProvider } from 'lite-store-react';
...
function LiteStoreReactBase(props: any) {
  return <ParentContext />;
}

export default LiteStoreReactBase;
